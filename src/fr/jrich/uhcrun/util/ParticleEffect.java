...
public enum ParticleEffect {
    ...
    private static Map<String, ParticleEffect> NAME_MAP = new HashMap<String, ParticleEffect>();
    private static Map<Integer, ParticleEffect> ID_MAP = new HashMap<Integer, ParticleEffect>();
    private String name;
    private int id;
    ...
    public static class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                ParticlePacket.packetConstructor = ReflectionHandler.getConstructor(packetClass);
                ParticlePacket.getHandle = ReflectionHandler.getMethod("CraftPlayer", PackageType.CRAFTBUKKIT_ENTITY, "getHandle");
                ParticlePacket.playerConnection = ReflectionHandler.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false, "playerConnection");
                ParticlePacket.sendPacket = ReflectionHandler.getMethod(ParticlePacket.playerConnection.getType(), "sendPacket", PackageType.MINECRAFT_SERVER.getClass("Packet"));
