...
public class ScoreboardBuilder {
    ...
    public static ScoreboardBuilder builder(String name, String displayName, DisplaySlot display) {
        if (name.length() > 16) { throw new IllegalArgumentException("name.length > 16"); }
    ...
    public static ScoreboardBuilder from(String name, Scoreboard scoreboard) {
